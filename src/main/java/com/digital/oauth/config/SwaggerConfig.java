...
public class SwaggerConfig extends WebMvcConfigurationSupport {
    ...
    private ApiInfo metaData() {
        return new ApiInfoBuilder()
                .title("Single sign-on (SSO) OAuth Digital Team - OAuth2")
                ...
                .version("1.0.0")
                .license("Open Source Product - Digital Team")
                .licenseUrl("https://t.me/adigitalteam")
                .contact(new Contact("Digital Team", "https://t.me/adigitalteam", "https://t.me/adigitalteam"))
                .build();
    }
